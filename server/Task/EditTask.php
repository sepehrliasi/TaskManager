            ...
            <div class="col-12 col-lg-9 col-xl-7">
              <div class="card shadow-4-strong card-registration" style="border-radius: 5px; background-color: rgb(192, 203, 227);">
                <div class="card-body p-4 p-md-5">
                  <h3 class="mb-4 pb-2 pb-md-0 mb-md-5"><b style="color: darkslategrey ;">Create Task</b></h3>
                  <hr>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-4">
                            <div class="form-outline">
                                ...
                                <input id="title" type="text" class="form-control" placeholder="Enter name of the book" name="title" required>
                        ...
                        <div class="col-md-6 mb-4">
                            <div class="form-outline">
                                ...
                                <input id="description" type="textarea" class="form-control" placeholder="Enter description of the book" name="description">
